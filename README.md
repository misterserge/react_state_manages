...
| Критерий | React State | Zustand | Jotai | Redux Classic | RTK |
|----------|-------------|---------|-------|---------------|-----|
| **Размер** | 0kb (встроенный) | ~1kb | ~3kb | ~8kb | ~12kb |
| **Простота API** | 🟢 Простой | 🟢 Очень простой | 🟢 Простой | 🔴 Сложный | 🟡 Средний |
| **Boilerplate** | 🟡 Средний | 🟢 Минимальный | 🟢 Минимальный | 🔴 Много | 🟡 Умеренный |
| **Производительность** | 🟡 Средняя | 🟢 Отличная | 🟢 Отличная | 🟢 Отличная | 🟢 Отличная |
| **DevTools** | ❌ Нет | 🟡 Через middleware | 🟡 Через middleware | ✅ Отличные | ✅ Отличные |
| **TypeScript** | 🟢 Хорошая | 🟢 Отличная | 🟢 Отличная | 🟡 Средняя | 🟢 Отличная |
| **Async операции** | 🟡 Ручная | 🟢 Встроенная | 🟢 Встроенная | ⚠️ Нужен middleware | 🟢 createAsyncThunk |
| **Computed values** | 🟡 useMemo | 🟡 Селекторы | ✅ Производные атомы | 🟡 Селекторы | 🟡 Селекторы |
| **Экосистема** | ✅ React | 🟡 Растущая | 🟡 Растущая | ✅ Огромная | ✅ Огромная |
...
Проект создан для демонстрации различных подходов к state management в React.
